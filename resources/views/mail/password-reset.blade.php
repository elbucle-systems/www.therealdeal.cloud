...
<head>
    ...
    <title>{{ __('app.mail.password_title') }}</title>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
                    ...
                    <tr>
                        <td
                            ...
                            {{ __('app.mail.password_ignore') }}<br />
